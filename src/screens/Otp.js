...
const tip = 'For you security, a one time password has been sent to your email address. Please enter it below to continue.';
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.input}>
          {/* png size = 24px */}
          <Input
            icon={require('../../assets/images/check-mark24.png')}
            placeholder='OTP' 
            pasword
          />
        </View>
